<template>
    <div id="view_container">
        ...
        <section class="members">
            <div class="ppl">
                <div class="importance">Presidents</div>
                <div class="row">
                    <div class="member">
                    ...
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/shubhro-gupta.png');"><img src="../assets/members/shubhro-gupta.png"></div>
                        <h1 class="name">Shubhro Gupta</h1>
                        <h2 class="desig">Create[x]</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://shubhro.in" class="link" target="_blank"><img src="../assets/icons/website.png"></a>
                                <a href="https://github.com/shubhroGupta" class="link" target="_blank"><img src="../assets/icons/github.png"></a>
                                <a href="https://behance.net/shubhroGupta" class="link" target="_blank"><img src="../assets/icons/behance.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/siris-gupta.png');"><img src="../assets/members/siris-gupta.png"></div>
                        <h1 class="name">Siris Gupta</h1>
                        <h2 class="desig">Analogous, Config[x]</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://www.instagram.com/sirisgupta" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="member">
                        ...
                        <h1 class="name">TBA</h1>
                        <h2 class="desig">TBA</h2>
                        <div class="container">
                            <div class="links">
                                <p class="oops">TBA</p>
                            </div>
                ...
                <div class="row">
                    <div class="member">
                        ...
                        <h2 class="desig">RoboCTRL, Intellect, Deprehendo</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://mittalprakhar.github.io" class="link" target="_blank"><img src="../assets/icons/website.png"></a>
                                <a href="https://www.linkedin.com/in/prakhar-mittal-682ab1171/" class="link" target="_blank"><img src="../assets/icons/linkedin.png"></a>
                                <a href="https://www.youtube.com/channel/UCLJcSqdNpNGFMwSD7-Sd_jg" class="link" target="_blank"><img src="../assets/icons/youtube.png"></a>
                            </div>
                        </div>
                    </div>
                <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/pratyush-kumar.jpeg');"><img src="../assets/members/pratyush-kumar.jpeg"></div>
                ...
                <div class="row">
                    ...
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/param-kapur.jpeg');"><img src="../assets/members/param-kapur.jpeg"></div>
                        <h1 class="name">Param Kapur</h1>
                        <h2 class="desig">Geekathon, CodecPro</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://github.com/paramkpr" class="link" target="_blank"><img src="../assets/icons/github.png"></a>
                                <a href="https://www.instagram.com/param_kpr" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="member">
                        ...
                        <div class="container">
                            <div class="links">
                                <a href="https://www.instagram.com/devmalik09" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/kavi-chopra.png');"><img src="../assets/members/kavi-chopra.png"></div>
                        <h1 class="name">Kavi Chopra</h1>
                        <h2 class="desig">Photobuild</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://vsco.co/kavichopra" class="link" target="_blank"><img src="../assets/icons/vsco.png"></a>
                                <a href="https://m.youtube.com/channel/UC9qXKi4O8PljLJSmXE1Xn7g" class="link" target="_blank"><img src="../assets/icons/youtube.png"></a>
                                <a href="https://www.instagram.com/kavi._chopra" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="member">
                        ...
                        <div class="container">
                            <div class="links">
                                ...
                                <a href="https://www.instagram.com/chikki.in" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/jyotirmay-shelly.jpg');"><img src="../assets/members/jyotirmay-shelly.jpg"></div>
                        ...
                        <div class="container">
                            <div class="links">
                                ...
                                <a href="https://www.instagram.com/jyotirmay.shelly" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="member">
                        ...
                        <div class="container">
                            <div class="links">
                                <a href="https://www.behance.net/garvdeep" class="link" target="_blank"><img src="../assets/icons/behance.png"></a>
                                <a href="https://www.instagram.com/garvdeep.singh" class="link" target="_blank"><img src="../assets/icons/instagram.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="dp" style="background-image: url('../assets/members/surabhi-mishra.jpeg');"><img src="../assets/members/surabhi-mishra.jpeg"></div>
                        <h1 class="name">Surabhi Mishra</h1>
                        <h2 class="desig">Intellect</h2>
                        <div class="container">
                            <div class="links">
                                <a href="https://www.facebook.com/profile.php?id=100015879672377" class="link"><img src="../assets/icons/facebook.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
